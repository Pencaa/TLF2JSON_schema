...
public class _21 {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(tKNLEN).append(sRVIND).append(tRANID).append(vALIDCDE).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _21) == false) {
            return false;
        }
        _21 rhs = ((_21) other);
        return new EqualsBuilder().append(tKNLEN, rhs.tKNLEN).append(sRVIND, rhs.sRVIND).append(tRANID, rhs.tRANID).append(vALIDCDE, rhs.vALIDCDE).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
